...
def _fit_binary(estimator, X, y, classes=None, grid_params=None, cv=None):
    ...
    if len(unique_y) == 1:
        ...
        if grid_params is None:
            ...
            grid = GridSearchCV(estimator, grid_params, cv=cv, n_jobs=-1)
            grid.fit(X, y)
...
class OneVsRestClassifier(
    ...
    def fit(self, X, y, grid_params=None, cv=None):
